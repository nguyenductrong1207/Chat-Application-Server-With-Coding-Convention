...
public class UserConversationOverview extends UseCase<UserConversationOverview.InputValues, UserConversationOverview.OutputValues> {
    private DataStorage _dataStorage;

    public UserConversationOverview(DataStorage dataStorage) {
        super();
