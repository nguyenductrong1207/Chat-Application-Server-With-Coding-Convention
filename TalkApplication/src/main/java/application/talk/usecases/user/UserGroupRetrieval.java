...
public class UserGroupRetrieval extends UseCase<UserGroupRetrieval.InputValues, UserGroupRetrieval.OutputValues> {
	private DataStorage _dataStorage;

	public UserGroupRetrieval(DataStorage dataStorage) {
