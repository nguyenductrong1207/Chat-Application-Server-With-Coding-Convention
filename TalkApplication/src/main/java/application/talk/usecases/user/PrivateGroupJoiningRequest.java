...
public class PrivateGroupJoiningRequest extends UseCase<PrivateGroupJoiningRequest.InputValues, PrivateGroupJoiningRequest.OutputValues> {
    private DataStorage _dataStorage;

    public PrivateGroupJoiningRequest(DataStorage dataStorage) {
        super();
