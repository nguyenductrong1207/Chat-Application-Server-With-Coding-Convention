...
public class SeeAllConversationOfUserTest {
    ...
    public void setUp() throws Exception {
        ...
        _useCase = new SeeAllConversationOfUser(_storage);
    }
    ...
    public void testSeeAllConversationOfUser() {
        ...
        SeeAllConversationOfUser.InputValues input = new SeeAllConversationOfUser.InputValues(user.getId());
        SeeAllConversationOfUser.OutputValues output = _useCase.execute(input);
